...
<center>
 `Foto da apresentação do TCC`. 

 `Da esquerda para a direita:` 

  `Prof. Wagner Hugo Bonat (orientador).`
  
  `Prof. Walmes Marques Zeviani (banca).`
  
  `Lineu Alberto Cavazani de Freitas (eu).`
  
  `Jhenifer Veloso & Samuel (na barriga).`
  
  `Prof. Cesar Auguto Taconeli (banca).`
